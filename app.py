...
lang = st.radio(
    "🌐",
    ["English", "Français", "فارسی", "中文", "한국어", "Español", "日本語"],
    horizontal=True,
    label_visibility="collapsed"
)

TRANSLATIONS = {
    "settings":          {"English": "⚙️ Settings",         "Français": "⚙️ Paramètres",      "فارسی": "⚙️ تنظیمات",          "中文": "⚙️ 设置",       "한국어": "⚙️ 설정",         "Español": "⚙️ Configuración",  "日本語": "⚙️ 設定"},
    "select_period":     {"English": "📅 Select Period",     "Français": "📅 Période",          "فارسی": "📅 انتخاب دوره",       "中文": "📅 选择周期",    "한국어": "📅 기간 선택",     "Español": "📅 Seleccionar período", "日本語": "📅 期間選択"},
    "enter_tickers":     {"English": "🏢 Enter Tickers (up to 10)", "Français": "🏢 Titres (max 10)", "فارسی": "🏢 نماد (حداکثر ۱۰)", "中文": "🏢 输入股票代码（最多10个）", "한국어": "🏢 티커 입력 (최대 10개)", "Español": "🏢 Ingresar tickers (máx 10)", "日本語": "🏢 ティッカー入力（最大10件）"},
    "caption":           {"English": "Enter tickers and quantity, then click Analyze.", "Français": "Entrez les titres et cliquez sur Analyser.", "فارسی": "نماد و تعداد را وارد کنید، سپس تحلیل را بزنید.", "中文": "输入代码和数量，然后点击分析。", "한국어": "티커와 수량을 입력한 뒤 분석하기를 눌러주세요.", "Español": "Ingrese tickers y cantidad, luego haga clic en Analizar.", "日本語": "ティッカーと数量を入力して分析をクリックしてください。"},
    "ticker":            {"English": "Ticker",               "Français": "Titre",               "فارسی": "نماد",                 "中文": "代码",          "한국어": "티커",             "Español": "Ticker",             "日本語": "ティッカー"},
    "qty":               {"English": "Qty",                  "Français": "Qté",                 "فارسی": "تعداد",                "中文": "数量",          "한국어": "수량",             "Español": "Cant.",              "日本語": "数量"},
    "analyze":           {"English": "🔍 Analyze",           "Français": "🔍 Analyser",         "فارسی": "🔍 تحلیل",             "中文": "🔍 分析",       "한국어": "🔍 분석하기",      "Español": "🔍 Analizar",        "日本語": "🔍 分析する"},
    "loading":           {"English": "Loading data...",      "Français": "Chargement...",        "فارسی": "در حال بارگذاری...",   "中文": "加载数据中...", "한국어": "데이터 불러오는 중...", "Español": "Cargando datos...", "日本語": "データ読込中..."},
    "no_data":           {"English": "Could not find data for", "Français": "Données introuvables pour", "فارسی": "داده‌ای یافت نشد برای", "中文": "找不到数据：", "한국어": "데이터를 찾을 수 없어요:", "Español": "No se encontraron datos para", "日本語": "データが見つかりません:"},
    "no_valid":          {"English": "No valid ticker data found.", "Français": "Aucune donnée valide.", "فارسی": "هیچ داده‌ای یافت نشد.", "中文": "未找到有效数据。", "한국어": "유효한 종목 데이터가 없어요.", "Español": "No se encontraron datos válidos.", "日本語": "有効なデータが見つかりません。"},
    "saved":             {"English": "✅ Saved to Supabase!", "Français": "✅ Sauvegardé!",      "فارسی": "✅ ذخیره شد!",          "中文": "✅ 已保存！",   "한국어": "✅ Supabase에 저장 완료!", "Español": "✅ Guardado en Supabase!", "日本語": "✅ Supabaseに保存しました！"},
    "save_failed":       {"English": "Save failed",          "Français": "Échec sauvegarde",    "فارسی": "ذخیره ناموفق",         "中文": "保存失败",      "한국어": "저장 실패",         "Español": "Error al guardar",   "日本語": "保存失敗"},
    "portfolio":         {"English": "📋 Portfolio Summary", "Français": "📋 Résumé portefeuille","فارسی": "📋 خلاصه پرتفوی",      "中文": "📋 投资组合摘要","한국어": "📋 포트폴리오 요약", "Español": "📋 Resumen del portafolio", "日本語": "📋 ポートフォリオ概要"},
    "start_price":       {"English": "Start Price",          "Français": "Prix initial",        "فارسی": "قیمت ابتدایی",         "中文": "起始价格",      "한국어": "시작가",           "Español": "Precio inicial",     "日本語": "開始価格"},
    "current_price":     {"English": "Current Price",        "Français": "Prix actuel",         "فارسی": "قیمت فعلی",            "中文": "当前价格",      "한국어": "현재가",           "Español": "Precio actual",      "日本語": "現在価格"},
    "return":            {"English": "Return",               "Français": "Rendement",           "فارسی": "بازده",                "中文": "收益率",        "한국어": "수익률",           "Español": "Rendimiento",        "日本語": "リターン"},
    "market_value":      {"English": "Market Value",         "Français": "Valeur marchande",    "فارسی": "ارزش بازار",           "中文": "市值",          "한국어": "평가금액",         "Español": "Valor de mercado",   "日本語": "時価評価額"},
    "combined_chart":    {"English": "📊 Combined Close Price Chart", "Français": "📊 Graphique comparatif", "فارسی": "📊 نمودار مقایسه‌ای", "中文": "📊 综合收盘价图", "한국어": "📊 통합 종가 비교 차트", "Español": "📊 Gráfico combinado", "日本語": "📊 統合終値チャート"},
    "date":              {"English": "Date",                 "Français": "Date",                "فارسی": "تاریخ",                "中文": "日期",          "한국어": "날짜",             "Español": "Fecha",              "日本語": "日付"},
    "close_price":       {"English": "Close Price (USD)",    "Français": "Prix clôture (USD)",  "فارسی": "قیمت بسته (USD)",      "中文": "收盘价 (USD)",  "한국어": "종가 (USD)",       "Español": "Precio cierre (USD)", "日本語": "終値 (USD)"},
    "individual":        {"English": "🔬 Individual Stock Analysis", "Français": "🔬 Analyse individuelle", "فارسی": "🔬 تحلیل انفرادی", "中文": "🔬 个股详细分析", "한국어": "🔬 개별 종목 상세 분석", "Español": "🔬 Análisis individual", "日本語": "🔬 個別銘柄詳細分析"},
    "prev_close":        {"English": "Prev Close",           "Français": "Clôture préc.",       "فارسی": "بسته قبلی",            "中文": "前收盘价",      "한국어": "전일 종가",        "Español": "Cierre anterior",    "日本語": "前日終値"},
    "market_cap":        {"English": "Market Cap",           "Français": "Capitalisation",      "فارسی": "ارزش بازار",           "中文": "市值",          "한국어": "시가총액",         "Español": "Cap. de mercado",    "日本語": "時価総額"},
    "open":              {"English": "Open",                 "Français": "Ouverture",           "فارسی": "باز",                  "中文": "开盘价",        "한국어": "시가",             "Español": "Apertura",           "日本語": "始値"},
    "close":             {"English": "Close",                "Français": "Clôture",             "فارسی": "بسته",                 "中文": "收盘价",        "한국어": "종가",             "Español": "Cierre",             "日本語": "終値"},
    "high":              {"English": "High",                 "Français": "Haut",                "فارسی": "بالاترین",             "中文": "最高价",        "한국어": "고가",             "Español": "Máximo",             "日本語": "高値"},
    "low":               {"English": "Low",                  "Français": "Bas",                 "فارسی": "پایین‌ترین",           "中文": "最低价",        "한국어": "저가",             "Español": "Mínimo",             "日本語": "安値"},
    "candlestick":       {"English": "Candlestick + Indicators", "Français": "Chandeliers + Indicateurs", "فارسی": "شمع + شاخص‌ها", "中文": "K线图 + 指标", "한국어": "캔들 차트 + 보조지표", "Español": "Velas + Indicadores", "日本語": "ローソク足 + 指標"},
    "volume":            {"English": "Volume",               "Français": "Volume",              "فارسی": "حجم",                  "中文": "成交量",        "한국어": "거래량",           "Español": "Volumen",            "日本語": "出来高"},
    "latest_news":       {"English": "📰 Latest News",       "Français": "📰 Dernières nouvelles","فارسی": "📰 آخرین اخبار",       "中文": "📰 最新新闻",   "한국어": "📰 최신 뉴스",     "Español": "📰 Últimas noticias", "日本語": "📰 最新ニュース"},
    "no_news":           {"English": "No news in the last 7 days.", "Français": "Aucune nouvelle (7j).", "فارسی": "خبری در ۷ روز گذشته نیست.", "中文": "过去7天无新闻。", "한국어": "최근 7일간 뉴스가 없어요.", "Español": "Sin noticias en los últimos 7 días.", "日本語": "直近7日間のニュースはありません。"},
    "no_key":            {"English": "🔑 Add FINNHUB_API_KEY to secrets.", "Français": "🔑 Ajoutez FINNHUB_API_KEY.", "فارسی": "🔑 کلید FINNHUB_API_KEY را اضافه کنید.", "中文": "🔑 请添加 FINNHUB_API_KEY。", "한국어": "🔑 FINNHUB_API_KEY를 secrets에 추가해주세요.", "Español": "🔑 Agrega FINNHUB_API_KEY a secrets.", "日本語": "🔑 SecretsにFINNHUB_API_KEYを追加してください。"},
    "enter_one":         {"English": "Please enter at least one ticker.", "Français": "Entrez au moins un titre.", "فارسی": "حداقل یک نماد وارد کنید.", "中文": "请至少输入一个股票代码。", "한국어": "최소 1개 이상의 티커를 입력해주세요.", "Español": "Ingrese al menos un ticker.", "日本語": "少なくとも1つのティッカーを入力してください。"},
    "last_updated":      {"English": "Data as of",            "Français": "Données au",          "فارسی": "داده‌ها تا",            "中文": "数据更新于",    "한국어": "데이터 기준",      "Español": "Datos al",           "日本語": "データ更新日時"},
    "cache_note":        {"English": "refreshes every 20 min","Français": "actualisation 20 min","فارسی": "بروزرسانی هر ۲۰ دقیقه","中文": "每20分钟刷新",  "한국어": "20분마다 갱신",    "Español": "actualiza cada 20 min", "日本語": "20分ごとに更新"},
    "info":              {"English": "👈 Enter a period and tickers on the left, then click Analyze.", "Français": "👈 Entrez une période et des titres, puis cliquez sur Analyser.", "فارسی": "👈 دوره و نماد را وارد کنید، سپس تحلیل را بزنید.", "中文": "👈 在左侧输入周期和代码，然后点击分析。", "한국어": "👈 왼쪽에서 기간과 종목을 입력하고 분석하기를 눌러주세요.", "Español": "👈 Ingrese período y tickers a la izquierda, luego haga clic en Analizar.", "日本語": "👈 左側で期間とティッカーを入力して分析をクリックしてください。"},
    "login":             {"English": "🔐 Login",               "Français": "🔐 Connexion",        "فارسی": "🔐 ورود",               "中文": "🔐 登录",       "한국어": "🔐 로그인",        "Español": "🔐 Iniciar sesión",  "日本語": "🔐 ログイン"},
    "signup":            {"English": "📝 Sign Up",             "Français": "📝 Inscription",      "فارسی": "📝 ثبت‌نام",            "中文": "📝 注册",       "한국어": "📝 회원가입",      "Español": "📝 Registrarse",     "日本語": "📝 サインアップ"},
    "nickname":          {"English": "Nickname",               "Français": "Pseudonyme",          "فارسی": "نام کاربری",            "中文": "昵称",          "한국어": "닉네임",           "Español": "Apodo",              "日本語": "ニックネーム"},
    "password":          {"English": "Password",               "Français": "Mot de passe",        "فارسی": "رمز عبور",              "中文": "密码",          "한국어": "비밀번호",         "Español": "Contraseña",         "日本語": "パスワード"},
    "login_btn":         {"English": "Login",                  "Français": "Se connecter",        "فارسی": "ورود",                  "中文": "登录",          "한국어": "로그인",           "Español": "Iniciar sesión",     "日本語": "ログイン"},
    "signup_btn":        {"English": "Create Account",         "Français": "Créer un compte",     "فارسی": "ایجاد حساب",            "中文": "创建账户",      "한국어": "계정 만들기",      "Español": "Crear cuenta",       "日本語": "アカウント作成"},
    "logout_btn":        {"English": "Logout",                 "Français": "Déconnexion",         "فارسی": "خروج",                  "中文": "退出",          "한국어": "로그아웃",         "Español": "Cerrar sesión",      "日本語": "ログアウト"},
    "welcome":           {"English": "Welcome",                "Français": "Bienvenue",           "فارسی": "خوش آمدید",             "中文": "欢迎",          "한국어": "환영해요",         "Español": "Bienvenido",         "日本語": "ようこそ"},
    "wrong_pw":          {"English": "❌ Wrong password.",     "Français": "❌ Mot de passe incorrect.", "فارسی": "❌ رمز اشتباه است.", "中文": "❌ 密码错误。", "한국어": "❌ 비밀번호가 틀렸어요.", "Español": "❌ Contraseña incorrecta.", "日本語": "❌ パスワードが違います。"},
    "no_user":           {"English": "❌ Nickname not found.", "Français": "❌ Pseudonyme introuvable.", "فارسی": "❌ نام کاربری یافت نشد.", "中文": "❌ 未找到该昵称。", "한국어": "❌ 닉네임을 찾을 수 없어요.", "Español": "❌ Apodo no encontrado.", "日本語": "❌ ニックネームが見つかりません。"},
    "nick_taken":        {"English": "❌ Nickname already taken.", "Français": "❌ Pseudonyme déjà pris.", "فارسی": "❌ این نام قبلاً گرفته شده.", "中文": "❌ 昵称已被使用。", "한국어": "❌ 이미 사용 중인 닉네임이에요.", "Español": "❌ Apodo ya en uso.", "日本語": "❌ そのニックネームは既に使われています。"},
    "account_created":   {"English": "✅ Account created! Please login.", "Français": "✅ Compte créé! Connectez-vous.", "فارسی": "✅ حساب ایجاد شد! وارد شوید.", "中文": "✅ 账户已创建！请登录。", "한국어": "✅ 계정이 만들어졌어요! 로그인해주세요.", "Español": "✅ ¡Cuenta creada! Inicie sesión.", "日本語": "✅ アカウントが作成されました！ログインしてください。"},
    "history":           {"English": "📂 My Analysis History", "Français": "📂 Mon historique",   "فارسی": "📂 تاریخچه تحلیل‌ها",   "中文": "📂 我的分析记录","한국어": "📂 내 분석 내역",  "Español": "📂 Mi historial",    "日本語": "📂 分析履歴"},
    "no_history":        {"English": "No analysis history yet.", "Français": "Aucun historique.", "فارسی": "هنوز تاریخچه‌ای وجود ندارد.", "中文": "暂无分析记录。", "한국어": "아직 분석 내역이 없어요.", "Español": "Sin historial aún.", "日本語": "分析履歴はまだありません。"},
    "load_history":      {"English": "Load",                   "Français": "Charger",             "فارسی": "بارگذاری",              "中文": "加载",          "한국어": "불러오기",         "Español": "Cargar",             "日本語": "読み込む"},
    "login_required":    {"English": "👈 Please login or sign up to use the app.", "Français": "👈 Connectez-vous pour utiliser l'app.", "فارسی": "👈 برای استفاده وارد شوید.", "中文": "👈 请登录或注册以使用应用。", "한국어": "👈 로그인 또는 회원가입 후 이용해주세요.", "Español": "👈 Inicie sesión para usar la app.", "日本語": "👈 アプリを使用するにはログインしてください。"},
    "session_name":      {"English": "📁 Analysis Name (optional)", "Français": "📁 Nom de l'analyse (optionnel)", "فارسی": "📁 نام تحلیل (اختیاری)", "中文": "📁 分析名称（可选）", "한국어": "📁 분석 이름 (선택)", "Español": "📁 Nombre del análisis (opcional)", "日本語": "📁 分析名（任意）"},
    "session_placeholder":{"English": "e.g. Tech Portfolio Q2", "Français": "ex: Portefeuille Tech", "فارسی": "مثال: پرتفوی فناوری", "中文": "例：科技股Q2", "한국어": "예: 테크 포트폴리오 Q2", "Español": "ej: Portafolio Tech Q2", "日本語": "例: テックポートフォリオQ2"},
    "change_pw":         {"English": "🔑 Change Password",    "Français": "🔑 Changer le mot de passe", "فارسی": "🔑 تغییر رمز عبور", "中文": "🔑 修改密码", "한국어": "🔑 비밀번호 변경", "Español": "🔑 Cambiar contraseña", "日本語": "🔑 パスワード変更"},
    "current_pw":        {"English": "Current Password",      "Français": "Mot de passe actuel",  "فارسی": "رمز فعلی",       "中文": "当前密码",   "한국어": "현재 비밀번호",    "Español": "Contraseña actual",  "日本語": "現在のパスワード"},
    "new_pw":            {"English": "New Password",          "Français": "Nouveau mot de passe", "فارسی": "رمز جدید",       "中文": "新密码",     "한국어": "새 비밀번호",      "Español": "Nueva contraseña",   "日本語": "新しいパスワード"},
    "confirm_pw":        {"English": "Confirm New Password",  "Français": "Confirmer le nouveau", "فارسی": "تأیید رمز جدید", "中文": "确认新密码", "한국어": "새 비밀번호 확인",  "Español": "Confirmar contraseña", "日本語": "新しいパスワードの確認"},
    "pw_changed":        {"English": "✅ Password changed!",  "Français": "✅ Mot de passe modifié!", "فارسی": "✅ رمز تغییر کرد!", "中文": "✅ 密码已修改！", "한국어": "✅ 비밀번호가 변경됐어요!", "Español": "✅ ¡Contraseña cambiada!", "日本語": "✅ パスワードが変更されました！"},
    "pw_mismatch":       {"English": "❌ Passwords don't match.", "Français": "❌ Les mots de passe ne correspondent pas.", "فارسی": "❌ رمزها یکسان نیستند.", "中文": "❌ 密码不匹配。", "한국어": "❌ 비밀번호가 일치하지 않아요.", "Español": "❌ Las contraseñas no coinciden.", "日本語": "❌ パスワードが一致しません。"},
    "admin_page":        {"English": "🛡️ Admin Panel",        "Français": "🛡️ Panneau Admin",     "فارسی": "🛡️ پنل مدیریت",  "中文": "🛡️ 管理面板", "한국어": "🛡️ 관리자 페이지", "Español": "🛡️ Panel Admin",     "日本語": "🛡️ 管理パネル"},
    "total_users":       {"English": "Total Users",           "Français": "Utilisateurs",         "فارسی": "کل کاربران",     "中文": "总用户数",   "한국어": "전체 유저",        "Español": "Total usuarios",     "日本語": "総ユーザー数"},
    "total_trades":      {"English": "Total Analyses",        "Français": "Analyses totales",     "فارسی": "کل تحلیل‌ها",    "中文": "总分析次数", "한국어": "전체 분석 수",     "Español": "Total análisis",     "日本語": "総分析数"},
    "all_users":         {"English": "👥 All Users",          "Français": "👥 Tous les utilisateurs", "فارسی": "👥 همه کاربران", "中文": "👥 所有用户", "한국어": "👥 전체 유저 목록", "Español": "👥 Todos los usuarios", "日本語": "👥 全ユーザー"},
    "all_trades":        {"English": "📊 All Trade Records",  "Français": "📊 Tous les trades",   "فارسی": "📊 همه معاملات",  "中文": "📊 所有交易记录", "한국어": "📊 전체 거래 내역", "Español": "📊 Todos los registros", "日本語": "📊 全取引記録"},
    "delete_user":       {"English": "🗑️ Delete User",        "Français": "🗑️ Supprimer",         "فارسی": "🗑️ حذف کاربر",   "中文": "🗑️ 删除用户", "한국어": "🗑️ 유저 삭제",     "Español": "🗑️ Eliminar usuario", "日本語": "🗑️ ユーザー削除"},
    "user_deleted":      {"English": "✅ User deleted.",       "Français": "✅ Utilisateur supprimé.", "فارسی": "✅ کاربر حذف شد.", "中文": "✅ 用户已删除。", "한국어": "✅ 유저가 삭제됐어요.", "Español": "✅ Usuario eliminado.", "日本語": "✅ ユーザーが削除されました。"},
}
...
PERIODS = {
    ...
    "Español": {"1 día":"1d","3 días":"5d","1 semana":"1wk","2 semanas":"2wk","1 mes":"1mo","3 meses":"3mo","6 meses":"6mo","1 año":"1y","2 años":"2y","5 años":"5y"},
    "日本語":  {"1日":"1d","3日":"5d","1週間":"1wk","2週間":"2wk","1ヶ月":"1mo","3ヶ月":"3mo","6ヶ月":"6mo","1年":"1y","2年":"2y","5年":"5y"},
}
